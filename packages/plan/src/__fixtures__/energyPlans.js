    ...
    accordion: [
      {
        ...
        content:
          '<style type="text/css">ul li { margin-left: 25px; list-style-type: disc; }\r\n</style>\r\n<p><strong>Why Alinta Energy?</strong></p>\r\n\r\n<ul style="list-style: disc inside;">\r\n\t<li>Join over 790,000 Australian&rsquo;s who have chosen Alinta Energy.</li>\r\n\t<li>Deal with an established energy retailer with a long proud history in Australia dating back to 1941</li>\r\n\t<li>No credit card merchant fees including American Express</li>\r\n\t<li>Flexible billing and payment options giving you the freedom to choose</li>\r\n\t<li>We offer solar feed in tariffs</li>\r\n\t<li>Online account management - access your account online 24/7 with Alinta Energy&rsquo;s My Account.</li>\r\n\t<li>Alinta Energy doesn&rsquo;t charge for posting paper energy bills&nbsp;</li>\r\n</ul>\r\n\r\n<p><strong>Alinta Energy&rsquo;s Product offer:</strong></p>\r\n\r\n<ul style="list-style: disc inside;">\r\n\t<li>Competitive pricing with attractive discounts</li>\r\n\t<li>Defined benefit period of 24 months</li>\r\n\t<li>No lock in contracts and no exit fees</li>\r\n\t<li>No late payment fees</li>\r\n\t<li>All our products are Solar Compatible.</li>\r\n</ul>\r\n\r\n<p><strong>Discounts and Bonuses</strong></p>\r\n\r\n<ul style="list-style: disc inside;">\r\n\t<li>Pay on Time Discount: 28% off electricity usage charges for each account you pay on time and in full. Rates are based on Alinta Energy&rsquo;s published Standing Tariffs for South Australia which are subject to change in accordance with applicable laws and may change during the 24 month benefit period.</li>\r\n\t<li>Pay on Time Discount: 12% off natural gas usage charges for each account you pay on time and in full. Rates are based on Alinta Energy&rsquo;s published Standing Tariffs for South Australia which are subject to change in accordance with applicable laws and may change during the defined benefit period.</li>\r\n\t<li>Defined Benefit Period: 24 months from the commencement date.</li>\r\n</ul>\r\n\r\n<p><strong>Contract Features</strong></p>\r\n\r\n<ul style="list-style: disc inside;">\r\n\t<li>Contract Early Termination Fee: $0 - there are no exit fees.&nbsp;</li>\r\n\t<li>No Contract Term. If you wish to change, switch or cancel your Fair Deal 28</li>\r\n\t<li>plan, you can do so at any stage without incurring a cancellation fee.</li>\r\n\t<li>Tariffs: You will pay Alinta Energy&#39;s published Standing Tariffs for South Australia if you do not pay your account on time and in full.</li>\r\n</ul>\r\n\r\n<p><strong>Payment Frequency</strong></p>\r\n\r\n<ul style="list-style: disc inside;">\r\n\t<li>Electricity: Standard quarterly payments.</li>\r\n\t<li>Gas: Standard bi-monthly payments.</li>\r\n\t<li>If you would like to pay your account in convenient monthly instalments then take advantage of our Payment Smoothing option associated with this plan.</li>\r\n</ul>\r\n\r\n<p><strong>Billing Method &amp; Frequency</strong></p>\r\n\r\n<ul style="list-style: disc inside;">\r\n\t<li>Paper or Electronic: Electricity accounts issued quarterly and gas accounts issued bi-monthly. Accounts will be sent to the billing or email address which you nominate.</li>\r\n</ul>\r\n\r\n<p><strong>Payment options</strong></p>\r\n\r\n<ul dir="ltr" style="list-style: disc inside;">\r\n\t<li>In person at Australia Post</li>\r\n\t<li>BPAY</li>\r\n\t<li>Telephone or internet (credit card): MasterCard, Visa or American Express accepted</li>\r\n\t<li>Direct Debit: Direct Debit from cheque, savings, transaction or credit card accounts</li>\r\n\t<li>By mail (cheque)</li>\r\n\t<li>Payment Smoothing : Monthly instalments from cheque, savings, transaction or credit card accounts</li>\r\n</ul>\r\n',
      },
      {
