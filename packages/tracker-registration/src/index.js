...
class TrackerRegistration extends React.Component {
  ...
  componentDidMount() {
    ...
    googleAnalytics.innerHTML = "(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){"+
    "(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),"+
    "m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)" +
    "})(window,document,'script','https://www.google-analytics.com/analytics.js','ga');" +
    "ga('create', '"+ `${ this.props.ga_code }` +"', 'auto');" +
    "ga('send', 'pageview');";
    ...
    adwords2.innerHTML = "window.dataLayer = window.dataLayer || [];" +
    "function gtag() {" +
      "dataLayer.push(arguments);" +
    "}" +
    "gtag('js', new Date());" +
    "gtag('config', '"+`${this.props.google_adwords_id}`+"');";
    this.instance.appendChild(adwords2);

    //FOR FACEBOOK PIXEL
    const fb1 = document.createElement('script');
    fb1.innerHTML = "!function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod?" +
      "n.callMethod.apply(n,arguments):n.queue.push(arguments)};if(!f._fbq)f._fbq=n;" +
      "n.push=n;n.loaded=!0;n.version='2.0';n.queue=[];t=b.createElement(e);t.async=!0;" +
      "t.src=v;s=b.getElementsByTagName(e)[0];s.parentNode.insertBefore(t,s)}(window," +
      "document,'script','https://connect.facebook.net/en_US/fbevents.js');" +
      "fbq('init', '"+`${this.props.facebook_pixel_id}`+"');" +
      "fbq('track', 'PageView');";
    ...
    fbimage.src = "https://www.facebook.com/tr?id="+`${this.props.facebook_pixel_id}`+"&amp;ev=PageView&amp;noscript=1";
  ...
  render() {
    return <div data-testid="testTrackingRegister" ref={el => (this.instance = el)} />;
  }
}
